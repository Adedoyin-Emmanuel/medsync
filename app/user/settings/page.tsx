  ...
  return (
    <>
      <Seo
        ...
        keywords="Settings, User settings, Caresync settings"
      />
      <div className="w-screen h-screen bg-zinc-50">
        {isLoading ? (
          ...
          <SidebarLayout>
            <section className="settings my-5">
              ...
              <section className="settings-section my-8">
                ...
                <Modal ref={verificationRef}>
                  <section className="confirm">
                    ...
                    <p className="my-3">
                      A verification mail would be sent to your inbox, do well
                      to check spam if you can't find the mail. Then follow the
                      mail instructions.
                    </p>
                  ...
                  >
                    ...
                    <section className="details">
                      ...
                      <Text className="text-sm">
                        Manage hospital that have access to your medical records
                      </Text>
                    </section>
                  </section>
